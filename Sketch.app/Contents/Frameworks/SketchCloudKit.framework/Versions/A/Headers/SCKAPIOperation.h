...
@interface SCKAPIOperation : NSOperation
...
@property (strong, nullable, readonly) NSArray<SCKObject *> *result;
 ...
 */
+ (void)executeRequest:(SCKAPIRequest *)request completionHandler:(void (^)(NSArray<SCKObject *>  * _Nullable objects, NSError * _Nullable error))handler;
